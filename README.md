...
can be used in contexts separate from maple syrup.
...
head(farms_coords)
#> # A tibble: 6 × 6
#>   farm                         address                  state region   lat  long
#>   <chr>                        <chr>                    <chr> <chr>  <dbl> <dbl>
#> 1 Loudounberry Farm and Garden 14917 James Monroe Hwy,… VA    north…  39.1 -77.6
#> 2 Eagles Sugar Camp            5503 Jack Mountain Rd, … VA    shena…  38.4 -79.5
#> 3 Fair Lawn Farm               3118 Mill Gap Road, Mon… VA    shena…  38.4 -79.7
#> 4 Laurel Fork Sapsuckers       10677 Mountain Turnpike… VA    shena…  38.4 -79.6
#> 5 Rexrode Maple Sugar Orchard  1564 Maple Sugar Rd, Mo… VA    shena…  38.4 -79.6
#> 6 Southernmost Maple           7738 Big Valley Rd, Bol… VA    shena…  38.2 -79.7
```

## Future Climate Projection

The `get_sens` family of functions can be used for future climate
