...
The following code chunk shows how to use `loca_t_rast()`, assuming you
downloaded LOCA2 data with the `download_loca2()` function and placed this data
into a folder called "LOCA2".

```{r loca_t_rast, eval = FALSE}
# Load in rasters
